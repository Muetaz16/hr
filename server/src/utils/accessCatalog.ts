...
export const SYSTEM_HATS: HatSeed[] = [
    {
        ...
        permissions: [
            ...
            'manage_leaves', 'manage_announcements', 'view_evaluations', 'view_hr_evaluations',
    ...
    },
    {
        key: 'PERSONNEL',
        name: 'Personnel',
        description: 'HR data-entry: register/edit employees, onboarding, IT issues.',
        permissions: ['view_directory', 'view_employees', 'register_employees', 'edit_employees', 'view_evaluations', 'view_lifecycle', 'manage_onboarding', 'manage_it_issues'],
    },
];
