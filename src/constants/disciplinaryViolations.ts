// Frontend mirror of server/src/utils/disciplinaryViolations.ts (IPH Code of Conduct, Annex I,
// effective 2026-01-01). Kept in sync manually since the frontend and backend are separate
// packages — this only changes when the company issues a new policy revision.
