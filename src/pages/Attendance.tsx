        ...
        <div className="max-w-[1400px] mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
            ...
            <Modal isOpen={mfModalOpen} onClose={() => setMfModalOpen(false)} title={mfEditing ? t('edit_multiplier_factor', { defaultValue: 'Edit Multiplier Factor' }) : t('add_multiplier_factor', { defaultValue: 'Add Multiplier Factor' })} maxWidth="max-w-lg">
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">{t('grace_period', { defaultValue: 'Grace Period' })}</label>
                        ...
                        <div>
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">{t('ot_threshold', { defaultValue: 'OT Threshold' })}</label>
