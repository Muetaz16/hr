                    ...
                    {showScope && (
                        <div className="mt-6 pt-6 border-t border-slate-100 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                {/* A Directorate head used to be asked to tick, by hand, every department
                                    they oversee. Their place in the org chart already says it: the
                                    directorate owns its divisions, those divisions own their
                                    departments, and those departments own their units. The list was a
                                    second answer to a question the chart had already answered, and the
                                    two drifted apart. Scope is now walked from the chart — see
                                    server/src/utils/orgScope.ts — so there is nothing to fill in here. */}
                                {formData.role === 'HEAD_DIRECTOR' && (
                                    <div className="sm:col-span-2 rounded-2xl border border-slate-100 bg-slate-50/70 p-4 text-[11px] font-medium text-slate-500 leading-relaxed">
                                        {t('directorate_scope_from_chart', {
                                            defaultValue: 'Scope comes from the org chart: this user covers every division, department and unit under the directorate their employee record belongs to. Nothing to assign here.',
                                        })}
                                    </div>
                                )}
